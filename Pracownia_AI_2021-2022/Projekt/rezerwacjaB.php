...
<div id="rezerwacja">
    ...
    O numerach rejestracyjnych: <?php echo $rejestracja?>
    <table>
    ...
    <tr><td>PESEL </td><td><input type="number" name="PESEL" min="10000000000" max="99999999999" size="11" required></td></tr>
    <tr><td>Data rozpoaczecia rezerwacji </td><td><input type="datetime-local" name="DataP" required></td></tr>
    <tr><td>Data zakonczenia rezerwacji </td><td><input type="datetime-local" name="DataK" required></td></tr>
    <tr><td colspan="2"><input type="submit" value="Zakoncz rezerwacje" name="Submit" required></td></tr>
    <tr><td colspan="2"><a href="bus_user.php">Wybierz ponownie pojazd</a></td></tr>
    </form>
    </table>
