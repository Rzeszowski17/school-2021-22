...
--
-- Host: 127.0.0.1
-- Czas generowania: 18 Lut 2022, 12:16
...
INSERT INTO `dane_osobowe` (`ID`, `ID_user`, `Imie`, `Nazwisko`, `PESEL`) VALUES
(1, 1, 'Jan', 'Kowalski', '11111111111');
...
INSERT INTO `prawo_jazdy` (`ID_osoby`, `Kategoria`) VALUES
(1, 'B');
...
--
ALTER TABLE `rezerwacje`
  MODIFY `ID_rezerwacjii` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
