...
<body>
    ...
    <div id="lista">
        <ul>
            ...
            <li><a href="./bus_user.php" id="us_visi">Busy</a></li>
    ...
    <div id="main_reszt"> 
        ...
        echo "<div class='przycisk'><form action='rezerwacjaB.php' method='POST'><input type='submit' value='Rezerwuj pojazd' name='submit$i'>";
