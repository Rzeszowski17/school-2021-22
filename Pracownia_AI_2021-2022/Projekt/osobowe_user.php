...
<body>
    ...
    <div id="lista">
        <ul>
            ...
            <li><a href="./osobowe_user.php" id="us_visi">Samochody osobowe</a></li>
    ...
    <div id="main_reszt"> 
        ...
        echo "<div class='przycisk'><form action='rezerwacjaO.php' method='POST'><input type='submit' value='Rezerwuj pojazd' name='submit$i'>";
